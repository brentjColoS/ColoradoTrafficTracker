...
class QuotaPressureHealthIndicatorTest {
    ...
    void healthIsOutOfServiceWhenQuotaCritical() {
        TrafficProps props = new TrafficProps("key", 60, "tile", 10, "", "I70", 4, 4, 500, 150, 35_000, 38_000, 40_000, true);
    ...
    void pointModeSkipsQuotaCheck() {
        TrafficProps props = new TrafficProps("key", 60, "point", 10, "", "I70", 4, 4, 500, 150, 35_000, 38_000, 40_000, true);
        QuotaPressureHealthIndicator indicator = new QuotaPressureHealthIndicator(
            props,
            tileTrafficPoller,
            new TrafficObservabilityProps(15, 80, 95, 3, 6)
    ...
    void healthUsesZeroPercentWhenHardStopMissing() {
        TrafficProps props = new TrafficProps("key", 60, "tile", 10, "", "I70", 4, 4, 500, 150, 35_000, 38_000, 0, true);
    ...
    void warningAndCriticalThresholdsAreClampedToAtLeastOnePercent() {
        TrafficProps props = new TrafficProps("key", 60, "tile", 10, "", "I70", 4, 4, 500, 150, 35_000, 38_000, 100, true);
        when(tileTrafficPoller.quotaSnapshot()).thenReturn(new TileTrafficPoller.QuotaSnapshot(1, 35_000, 38_000, 100));

        QuotaPressureHealthIndicator indicator = new QuotaPressureHealthIndicator(
            props,
            tileTrafficPoller,
            new TrafficObservabilityProps(15, 0, 0, 3, 6)
        );
