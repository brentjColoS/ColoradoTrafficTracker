...
BACKUP_RETENTION_COUNT="${DATABASE_BACKUP_RETENTION_COUNT:-13}"
...
[[ "$BACKUP_RETENTION_COUNT" =~ ^[0-9]+$ ]] \
  || fail "DATABASE_BACKUP_RETENTION_COUNT must be a non-negative whole number"
BACKUP_RETENTION_COUNT="$((10#$BACKUP_RETENTION_COUNT))"
