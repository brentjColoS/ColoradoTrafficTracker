...
## Experimental directional catalog

The corridor-map experiment adds a versioned two-carriageway catalog without
changing the routes currently used by the application. The generated resources
live under `routes-service/src/main/resources/routes/directional/v1/`.
...
figures establish geometric plausibility, not TomTom direction assignment.
That assignment remains gated on representative flow-feature evidence.
