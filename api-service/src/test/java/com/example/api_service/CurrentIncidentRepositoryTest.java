...
class CurrentIncidentRepositoryTest {
    ...
    void durableTimelineUsesLifecycleTimesRatherThanCurrentFlags() throws Exception {
        ...
        assertThat(query.value())
            ...
            .contains("e.source_ended_at is not null")
            .contains("least(e.source_ended_at, c.last_matched_at) >= :until")
            .contains("e.source_ended_at is null")
            .contains("least(e.last_seen_at, c.last_matched_at) >= :activeSince")
