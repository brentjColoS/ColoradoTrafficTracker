...
public final class TrafficSampleMapper {
    ...
    public static TrafficSampleDto toDto(TrafficSample sample) {
        return new TrafficSampleDto(
            ...
            sample.getValidationRequestedPoints(),
            sample.getValidationReturnedPoints(),
            sample.getValidationCoverageRatio(),
            sample.getValidationUsed(),
            sample.getDegraded(),
            sample.getDegradedReason(),
